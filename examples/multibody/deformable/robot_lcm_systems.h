...
https://github.com/DAIRLab/dairlib/blob/bibit/deform/systems/robot_lcm_systems.h
*/
#pragma once
...
// #include <drake/lcmt_object_state.hpp>

#include "drake/lcmt_robot_input.hpp"
#include "drake/lcmt_robot_output.hpp"
// #include "drake/systems/framework/output_vector.h" // problem
// #include "drake/systems/framework/state_vector.h" // problem
...
class RobotOutputSender : public drake::systems::LeafSystem<double> {
 ...
 private:
  void Output(const drake::systems::Context<double>& context,
              drake::lcmt_robot_output* output) const;
...
//  private:
//   void Output(const drake::systems::Context<double>& context,
//               drake::lcmt_object_state* output) const;
...
//                      drake::lcmt_robot_input* output) const;
